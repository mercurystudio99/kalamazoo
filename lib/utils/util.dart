class Util {
  ...
  static const String loginCaption = "Login With Your Account To continue";
  ...
  // Policy Screen
  static const String policyTitle = "Privacy Policy";
  static const List<Map<String, dynamic>> policyList = [
    {
      "title": "1.	Scope",
      "description":
